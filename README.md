...
| 파일                                    | 설명                           |
| ------------------------------------- | ---------------------------- |
| outputs/01_feature_table.csv          | 수요예측 feature table           |
| outputs/02_forecast_result.csv        | forecast_4w와 actual_4w 비교 결과 |
...
| Average Allocation Fill Rate |                      0.796205 |
| Total Unfulfilled Qty        |                        34,961 |
| Order Action Count           |                            15 |
| Timing Check Count           |                             8 |
| Reduce Review Count          |                             8 |
...
* Average Allocation Fill Rate는 약 79.6%로, SKU 공용재고 부족 상황에서 일부 채널 수요가 미충족되는 구조가 확인됩니다.
* Replenishment action은 hold, inbound monitoring, reduce review, timing check, order action으로 분산되어 S&OP 판단 구조가 작동함을 확인했습니다.
